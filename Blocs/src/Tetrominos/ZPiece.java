	...
	public boolean isClearBelow(TetrisBoard board) {
		...
		switch (getRotationBy90()) {
			...
			case 1:
				...
				if (board.isBooleanTileFilled(x+TetrisBoard.TILE_DIMEN, y+TetrisBoard.TILE_DIMEN) || board.isBooleanTileFilled(x, y+TetrisBoard.TILE_DIMEN*2)) {
			...
			case 3:
				...
				if (board.isBooleanTileFilled(x, y+TetrisBoard.TILE_DIMEN) || board.isBooleanTileFilled(x-TetrisBoard.TILE_DIMEN, y+TetrisBoard.TILE_DIMEN*2)) {
					Log.d("case 0 is NOT clear below", "x is "+x+" y is "+y);
					return false;
				} else {
					return true;
